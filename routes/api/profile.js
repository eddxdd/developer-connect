...
// @desc    Get current users profile by the user id in the token (requires middleware)
// @access  Private
router.get("/me", auth, async (req, res) => {
	try {
		// This refers to the ObjectId of user
...
router.post(
	...
	async (req, res) => {
		...
		// Look for an user profile
		// If found, update it
		// If not; create it, save it, and send back the profile
		try {
...
router.delete("/", auth, async (req, res) => {
	try {
		// It's important that the first two steps happen before deleting the user*
		// Remove user posts
